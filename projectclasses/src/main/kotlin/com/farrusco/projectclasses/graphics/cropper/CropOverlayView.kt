...
import com.farrusco.projectclasses.graphics.cropper.CropImageView.CropShape
import com.farrusco.projectclasses.graphics.cropper.CropImageView.Guidelines
    ...
    when (cropShape) {
      ...
      ->
        if (!isNonStraightAngleRotated) {
          ...
          canvas.withSave {
              clipOutPath(mPath)
              drawRect(left, top, right, bottom, mBackgroundPaint!!)
          }
        }
      CropShape.OVAL -> {
        mPath.reset()
